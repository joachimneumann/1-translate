...
final class TestDanish: XCTestCase {
    ...
    func test_danish() {
        ...
        XCTAssertEqual(danish.read(2_500), "to tusind og fem hundrede")
        XCTAssertEqual(danish.read(220_000), "to hundrede og tyve tusind")
        ...
        XCTAssertEqual(danish.read(3_142), "tre tusind og hundred og toogfyrre")
        XCTAssertEqual(danish.read(9_999), "ni tusind og ni hundrede og nioghalvfems")
        XCTAssertEqual(danish.read(10_000), "ti tusind")
        XCTAssertEqual(danish.read(10_001), "ti tusind og en")
        XCTAssertEqual(danish.read(10_002), "ti tusind og to")
        XCTAssertEqual(danish.read(20_001), "tyve tusind og en")
        XCTAssertEqual(danish.read(20_010), "tyve tusind og ti")
        XCTAssertEqual(danish.read(20_101), "tyve tusind og hundred og en")
        XCTAssertEqual(danish.read(201_001), "to hundrede og en tusind og en")
        XCTAssertEqual(danish.read(502_305), "fem hundrede og to tusind og tre hundrede og fem")
        XCTAssertEqual(danish.read(999_999), "ni hundrede og nioghalvfems tusind og ni hundrede og nioghalvfems")
        XCTAssertEqual(danish.read(62_000_000), "toogtres million")
        XCTAssertEqual(danish.read(62_003_005), "toogtres million og tre tusind og fem")
        XCTAssertEqual(danish.read(62_003_105), "toogtres million og tre tusind og hundred og fem")
        XCTAssertEqual(danish.read(62_003_155), "toogtres million og tre tusind og hundred og femoghalvtreds")
        XCTAssertEqual(danish.read(99_999_999), "nioghalvfems million og ni hundrede og nioghalvfems tusind og ni hundrede og nioghalvfems")
        XCTAssertEqual(danish.read(99_000_000_909), "nioghalvfems milliard og ni hundrede og ni")
