...
final class TestDanish: XCTestCase {
    ...
    func test_danish() {
        ...
        XCTAssertEqual(danish.read(102_102_000), "hundrede og to millioner og hundrede og to tusinde")
        ...
        XCTAssertEqual(danish.read(102_000_000_000_000), "hundrede og to billioner")
