...
final class TestPolish: XCTestCase {
    ...
    func test_polish() {
        ...
        XCTAssertEqual(polish.translate(63_000_000), "sześćdziesiąt trzy miliony")
        XCTAssertEqual(polish.translate(62_003_005), "sześćdziesiąt dwa miliony trzy tysiące pięć")
        XCTAssertEqual(polish.translate(64_000_000), "sześćdziesiąt cztery miliony")
        XCTAssertEqual(polish.translate(65_000_000), "sześćdziesiąt pięć milionów")
        XCTAssertEqual(polish.translate(66_000_000), "sześćdziesiąt sześć milionów")
        XCTAssertEqual(polish.translate(67_000_000), "sześćdziesiąt siedem milionów")
        XCTAssertEqual(polish.translate(68_000_000), "sześćdziesiąt osiem milionów")
        XCTAssertEqual(polish.translate(69_000_000), "sześćdziesiąt dziewięć milionów")
