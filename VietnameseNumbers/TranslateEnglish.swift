...
class TranslateEnglish: StandardTranslator {
    override func translatePositiveInteger_0_20(_ i: Int) -> String? {
        switch i {
        case 0:     return "zero"
        case 1:     return "one"
        case 2:     return "two"
    ...
    override func translatePositiveInteger_21_99(_ i: Int) -> String? {
        var temp = i
        let X = temp % 10
        temp = (temp - X) / 10
        let X0 = temp % 10
        ...
        if X > 0 {
            ret += "-" + translatePositiveInteger_0_20(X)!
        }
        return ret
    }
...
class TranslateEnglish2: GeneralTranslator {
