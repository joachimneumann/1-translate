...
final class Test_PortugueseEuropean: XCTestCase {
    let translator = PortugueseImplementation(variant: PortugueseImplementation.Variant.european)
    func testPortugueseEuropean() {
        ...
        XCTAssertEqual(translator.translate(1_000_000_000).x, "mil milhões")
        XCTAssertEqual(translator.translate(2_000_000_000).x, "dois mil milhões")
        XCTAssertEqual(translator.translate(1_000_000_000_000).x, "um bilião")
        XCTAssertEqual(translator.translate(2_000_000_000_000).x, "dois biliões")
    }
}
