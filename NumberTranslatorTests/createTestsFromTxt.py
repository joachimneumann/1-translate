...
for file in glob.glob("../../1-translate-tests/language/*.txt"):
    ...
    implementation = baseName+".swift"
    implementationWithPath = "../NumberTranslator/Languages/" + implementation
    ...
    writeln("")
    writeln("final class Test_"+baseName+": XCTestCase {")
    writeln("")
    writeln("    let language = "+baseName+"()")
    writeln("")
    writeln("    func test_"+baseName+"() {")
