...
final class Test_chineseSimplified: XCTestCase {
    ...
    func test_chineseSimplified() {
        ...
        XCTAssertEqual(language.read(1_000).x, "一千")
        XCTAssertEqual(language.read(1_001).x, "一千 零一")
        XCTAssertEqual(language.read(1_003).x, "一千 零三")
        XCTAssertEqual(language.read(1_005).x, "一千 零五")
        XCTAssertEqual(language.read(1_006).x, "一千 零六")
        XCTAssertEqual(language.read(1_010).x, "一千 零一十")
        XCTAssertEqual(language.read(1_020).x, "一千 零二十")
        XCTAssertEqual(language.read(1_035).x, "一千 零三十五")
        XCTAssertEqual(language.read(1_100).x, "一千 一百")
        XCTAssertEqual(language.read(1_111).x, "一千 一百 一十一")
        XCTAssertEqual(language.read(1_200).x, "一千 二百")
        XCTAssertEqual(language.read(1_234).x, "一千 二百 三十四")
        XCTAssertEqual(language.read(1_999).x, "一千 九百 九十九")
        XCTAssertEqual(language.read(2_000).x, "二千")
        XCTAssertEqual(language.read(2_001).x, "二千 零一")
        XCTAssertEqual(language.read(2_010).x, "二千 零一十")
        XCTAssertEqual(language.read(2_345).x, "二千 三百 四十五")
        XCTAssertEqual(language.read(3_000).x, "三千")
        XCTAssertEqual(language.read(3_454).x, "三千 四百 五十四")
        XCTAssertEqual(language.read(4_000).x, "四千")
        XCTAssertEqual(language.read(5_000).x, "五千")
        XCTAssertEqual(language.read(6_000).x, "六千")
        XCTAssertEqual(language.read(7_000).x, "七千")
        XCTAssertEqual(language.read(7_045).x, "七千 零四十五")
        XCTAssertEqual(language.read(8_000).x, "八千")
        XCTAssertEqual(language.read(9_000).x, "九千")
