...
final class Test_portugueseEuropean: XCTestCase {
    ...
    let language = Languages().portugueseEuropean

    func test_portugueseEuropean() {
        ...
        XCTAssertEqual(language.read(1_120_000).x, "um milhão e cento e vinte mil")
        ...
        XCTAssertEqual(language.read(7_543_100).x, "sete milhões e quinhentos e quarenta e três mil e cem")
