...
public extension Color {
    ...
    struct Neumorphic {
        ...
        private static let defaultTextColor               = NeumorphicKit.colorType(red: 0.282, green: 0.302, blue: 0.349)
        ...
        private static let darkThemeTextColor             = NeumorphicKit.colorType(red: 0.910, green: 0.910, blue: 0.910)
