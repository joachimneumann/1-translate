...
final class TestArmenian: XCTestCase{
    ...
    func test() {
        ...
        XCTAssertEqual(armenian.read(300), "հարյուր")
        ...
        XCTAssertEqual(armenian.read(3_000), "հազար")
        ...
        XCTAssertEqual(armenian.read(10_000), "տաս հազար")
