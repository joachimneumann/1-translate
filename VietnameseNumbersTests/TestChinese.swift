...
final class TestChinese: XCTestCase {
    ...
    func test_simplified() {
        ...
        XCTAssertEqual(simplified.read(1_010), "一千 零一十")
        XCTAssertEqual(simplified.read(1_020), "一千 零二十")
        XCTAssertEqual(simplified.read(1_100), "一千 一百")
        XCTAssertEqual(simplified.read(1_111), "一千 一百 一十一")
        XCTAssertEqual(simplified.read(1_200), "一千 二百")
        XCTAssertEqual(simplified.read(1_234), "一千 二百 三十四")
        XCTAssertEqual(simplified.read(1_999), "一千 九百 九十九")
        XCTAssertEqual(simplified.read(2_000), "二千")
        XCTAssertEqual(simplified.read(2_001), "二千 零一")
        XCTAssertEqual(simplified.read(2_010), "二千 零一十")
        XCTAssertEqual(simplified.read(2_345), "二千 三百 四十五")
        ...
        XCTAssertNotEqual(simplified.read(10_207), "一万 零 二百 零 七") // email conformation: not correct
        XCTAssertEqual(simplified.read(10_509), "一万 五百 零九")
        XCTAssertEqual(simplified.read(11_000), "一万 一千")
        XCTAssertEqual(simplified.read(11_050), "一万 一千 零五十")
        XCTAssertEqual(simplified.read(11_500), "一万 一千 五百")
        ...
        XCTAssertEqual(simplified.read(20_000), "二万 三千")
        XCTAssertEqual(simplified.read(23_456), "二万 三千 四百 五十六")
        XCTAssertEqual(simplified.read(31_240), "三万 一千 二百 四十")
        ...
        XCTAssertEqual(simplified.read(40_500), "四万 五百")
        ...
        XCTAssertEqual(simplified.read(110_000), "十一万")
        XCTAssertEqual(simplified.read(200_000), "二十万")
        XCTAssertEqual(simplified.read(214_000), "二十一万 四千")
        XCTAssertEqual(simplified.read(300_000), "三十万")
        XCTAssertEqual(simplified.read(567_000), "五十六万 七千")
        ...
        XCTAssertEqual(traditional.read(7_890_298), "七百 八十九万 零二百 九十八")
        ...
        XCTAssertEqual(simplified.read(34_567_890), "三千 四百 五十六万 七千 八百 九十")
        XCTAssertEqual(simplified.read(53_798_250), "五千 三百 七十九万 八千 二百 五十")
        
        /// https://www.chineseconverter.com/en/convert/arabic-numbers-to-chinese-numbers
        XCTAssertEqual(simplified.read(6_789_123).replacingOccurrences(of: " ", with: ""), "六百七十八万九千一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_120).replacingOccurrences(of: " ", with: ""), "六百七十八万九千一百二十".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_103).replacingOccurrences(of: " ", with: ""), "六百七十八万九千一百零三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_780_023).replacingOccurrences(of: " ", with: ""), "六百七十八万零二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_709_123).replacingOccurrences(of: " ", with: ""), "六百七十万零九千一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_089_123).replacingOccurrences(of: " ", with: ""), "六百零八万九千一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_123).replacingOccurrences(of: " ", with: ""), "六百七十八万九千一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_100).replacingOccurrences(of: " ", with: ""), "六百七十八万九千一百".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_003).replacingOccurrences(of: " ", with: ""), "六百七十八万九千零三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_780_023).replacingOccurrences(of: " ", with: ""), "六百七十八万零二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_700_123).replacingOccurrences(of: " ", with: ""), "六百七十万零一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_009_123).replacingOccurrences(of: " ", with: ""), "六百万零九千一百二十三".replacingOccurrences(of: " ", with: ""))
        
        XCTAssertEqual(simplified.read(6_789_123).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_120).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 一百二".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_103).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 一百〇三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_780_023).replacingOccurrences(of: " ", with: ""), "六百 七十八万 〇二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_709_123).replacingOccurrences(of: " ", with: ""), "六百 七万 九千 一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_089_123).replacingOccurrences(of: " ", with: ""), "六百 〇八万 九千 一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_123).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_100).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 一".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_789_003).replacingOccurrences(of: " ", with: ""), "六百 七十八万 九千 〇三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_780_023).replacingOccurrences(of: " ", with: ""), "六百 七十八万 〇二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_700_123).replacingOccurrences(of: " ", with: ""), "六百 七万 〇一百二十三".replacingOccurrences(of: " ", with: ""))
        XCTAssertEqual(simplified.read(6_009_123).replacingOccurrences(of: " ", with: ""), "六百万 九千 一百二十三".replacingOccurrences(of: " ", with: ""))
        ...
        XCTAssertEqual(simplified.read(123_456_789), "一亿 二千 三百 四十五万 六千 七百 八十九")
        XCTAssertEqual(simplified.read(414_294_182), "四亿 一千 四百 二十九 万 四千 一百 八十二")
        XCTAssertEqual(simplified.read(1_000_000_000), "十亿")
        XCTAssertEqual(simplified.read(1_326_800_000), "十三亿 二千 六百 八十 万")
...
//    https://www.youtube.com/watch?v=JG4m-UehKY4
        ...
        XCTAssertEqual(simplified.read(11_741), "一万一千七百四十一")
        XCTAssertEqual(simplified.read(50_555), "五万零五百五十五")
        XCTAssertEqual(simplified.read(100_222), "十万零二百二十二")
        XCTAssertEqual(simplified.read(123_446), "十二万三千四百四十六")
        XCTAssertEqual(simplified.read(200_300), "二十万零三百")
        XCTAssertEqual(simplified.read(1_123_456), "一百一十二万三千四百五十六")
        XCTAssertEqual(simplified.read(1_628_333), "一百六十二万八千三百三十三")
        XCTAssertEqual(simplified.read(678_987_654_321), "六千 七百 八十九亿 八千 七百六十五万 四千 三百三十")
    }
    ...
    func test_flexiclasses() {
        ...
        XCTAssertEqual(simplified.read(240_500_000), "二亿 四千 零五十万")
        ...
        XCTAssertEqual(simplified.read(200_800_000), "二亿零八十万")
