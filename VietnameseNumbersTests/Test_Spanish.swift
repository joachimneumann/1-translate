...
final class Test_Spanish: XCTestCase {
    func test_spanish() {
        ...
        XCTAssertEqual(spanish.translate(3.1415926), "tres punto uno cuatro uno cinco nueve dos seis")
        XCTAssertEqual(spanish.translate(-3.1415926), "menos tres punto uno cuatro uno cinco nueve dos seis")
        XCTAssertEqual(spanish.translate(3.4e16), "tres punto cuatro por diez elevado a dieciséis")
    }
}
